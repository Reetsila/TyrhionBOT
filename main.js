...
class Tyrhion extends Client {
    ...
    async unLoadCommand(commandPath, commandName) {
        ...
        if (!command) return `La commande \`${commandName}\` ne semble pas exister. Essayez à nouveau !`;
...
const init = async () => {
    ...
    client.logger.log(`Chargement de ${evtFiles.length} évènements.`, "log");
